...
var TagIdNamePipe = /** @class */ (function () {
    ...
    TagIdNamePipe.prototype.transform = function (value, args) {
        ...
        console.info(value, args[value], args);
        var output = '';
        return args[value];
    };
